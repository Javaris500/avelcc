  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="truncate text-[13px] text-text">{session.workspace}</span>
        <span aria-hidden="true" className="ml-auto font-mono text-[10px] text-text-subtle">
          ▾
        </span>
      </button>
      ...
      <div className="border-t border-[var(--elevation-border-rest)] p-2">
        ...
        >
          ...
          <span className="truncate text-[13px] text-text-muted">{session.operator}</span>
          <span className="ml-auto font-mono text-[10px] text-text-subtle">out</span>
        </button>
      </div>
    </nav>
  )
